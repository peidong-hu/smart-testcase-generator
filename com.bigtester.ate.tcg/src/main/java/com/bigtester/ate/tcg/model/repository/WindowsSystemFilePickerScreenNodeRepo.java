 ...
 */
@Repository
public interface WindowsSystemFilePickerScreenNodeRepo extends GraphRepository<WindowsSystemFilePickerScreenNode> {
	 ...
	 */
	@Nullable
	WindowsSystemFilePickerScreenNode getWindowsSystemFilePickerScreenNodeByUrlAndName(String screenUrl, String screenName);
}
