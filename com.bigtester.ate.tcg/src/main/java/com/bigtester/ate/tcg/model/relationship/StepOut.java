...
public class StepOut implements ATENeo4jNodeComparision{
	 ...
	 */
	public StepOut(Neo4jScreenNode startNode, Neo4jScreenNode endNode, long uitrId) {
	...
	public boolean sameNode(Object obj) {
		...
		if (obj instanceof StepOut) {
			...
			retVal = startNodeObj.sameNode(this.startNode)
					...
					&& ((StepOut) obj).getTriggerUitrId()==this.getTriggerUitrId();
			}
		}
		return retVal;
	} 
